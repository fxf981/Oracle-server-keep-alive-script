...
checkver() {
  ...
  curl -L https://github.com/fxf981/Oracle-server-keep-alive-script/raw/main/oalive.sh -o oalive1.sh && chmod +x oalive1.sh
...
calculate() {
  curl -L https://github.com/fxf981/Oracle-server-keep-alive-script/raw/main/cpu-limit.sh -o cpu-limit.sh && chmod +x cpu-limit.sh
  mv cpu-limit.sh /usr/local/bin/cpu-limit.sh
  chmod +x /usr/local/bin/cpu-limit.sh
  curl -L https://github.com/fxf981/Oracle-server-keep-alive-script/raw/main/cpu-limit.service -o cpu-limit.service && chmod +x cpu-limit.service
...
memory() {
  curl -L https://github.com/fxf981/Oracle-server-keep-alive-script/raw/main/memory-limit.sh -o memory-limit.sh && chmod +x memory-limit.sh
  mv memory-limit.sh /usr/local/bin/memory-limit.sh
  chmod +x /usr/local/bin/memory-limit.sh
  curl -L https://github.com/fxf981/Oracle-server-keep-alive-script/raw/main/memory-limit.service -o memory-limit.service && chmod +x memory-limit.service
...
bandwidth() {
  curl -L https://github.com/fxf981/Oracle-server-keep-alive-script/raw/main/bandwidth_occupier.sh -o bandwidth_occupier.sh && chmod +x bandwidth_occupier.sh
  mv bandwidth_occupier.sh /usr/local/bin/bandwidth_occupier.sh
  chmod +x /usr/local/bin/bandwidth_occupier.sh
  curl -L https://github.com/fxf981/Oracle-server-keep-alive-script/raw/main/bandwidth_occupier.timer -o bandwidth_occupier.timer && chmod +x bandwidth_occupier.timer
  mv bandwidth_occupier.timer /etc/systemd/system/bandwidth_occupier.timer
  curl -L https://github.com/fxf981/Oracle-server-keep-alive-script/raw/main/bandwidth_occupier.service -o bandwidth_occupier.service && chmod +x bandwidth_occupier.service
